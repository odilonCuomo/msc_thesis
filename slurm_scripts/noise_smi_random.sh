...
# set name of job
#SBATCH --job-name=noise_smi_rand
# partition priority
...
# same bound
echo 2 /
python gs_experiments/noisy_smi.py --metric "GRID_MEAN" --n 15 --noisy_side "suitors" --num_runs 1000 --noise_type "RANDOM" --window_size 2 --prefs_bound_sui 5 --prefs_bound_rev 5
